...
const (
	...
	EnvPowerCalcMode     = "POWER_CALC_MODE"
...
type Config struct {
	...
	PowerCalcMode     string // Power calculation mode: "max" or "average"
...
func Load() (*Config, error) {
	...
	return &Config{
		...
		PowerCalcMode:     getEnvOrDefault(EnvPowerCalcMode, DefaultPowerCalcMode),
